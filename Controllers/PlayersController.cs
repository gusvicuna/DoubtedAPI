...
namespace DoubtedAPI.Controllers
{
    ...
    public class PlayersController : ControllerBase
    {
        ...
        public PlayersController(PlayerContext context, UserContext userContext, GameContext gameContext)
        {
            _context = context;
        ...
        {
            var user = await _contextUser.Users.FindAsync(player.UserId);
